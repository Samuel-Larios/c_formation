            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="{{ route('students.export-import') }}">
                        ...
                        <li class="nav-item {{ request()->routeIs('promotion.statistics') ? 'active' : '' }}">
                            <a href="{{ route('promotion.statistics') }}">
                                <i class="fas fa-chart-bar"></i>
                                <span class="sub-item">Promotion Statistics</span>
                            </a>
                        </li>
                    ...
                    <ul>
                        {{-- Logo de mastercard --}}
                        <img src="{{ asset('assets/img/kaiadmin/mastercard-symbol-02.jpg') }}" alt="Mastercard Logo"
                            class="navbar-brand" height="100" width="auto">
                    </ul>
                </div>
            </div>
                                        ...
                                        <li>
                                            <div class="user-box d-flex align-items-center">
                                                ...
                                                <div class="u-text">
                                                    ...
                                                    <a href="#" class="btn btn-xs btn-secondary btn-sm">Voir le
                                                        profil</a>
                                                </div>
                                            </div>
                                        </li>
