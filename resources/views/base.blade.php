...
<head>
    ...
    <!-- Inclure jQuery complet pour AJAX -->
    ...
    <style>
        .mastercard-logo {
            position: fixed;
            bottom: 20px;
            /* Ajoute un espacement depuis le bas de l'écran */
            z-index: 999;
            /* S'assure que l'image reste au-dessus des autres éléments */
        }
    </style>
</head>
                ...
                <div class="sidebar-content">
                    ...
                    <ul>
                        ...
                        <li class="mastercard-logo">
                            <img src="{{ asset('assets/img/kaiadmin/mastercard-symbol-02.jpg') }}"
                                alt="Mastercard Logo" class="navbar-brand" height="100" width="auto">
                        </li>
                    </ul>
                </div>
